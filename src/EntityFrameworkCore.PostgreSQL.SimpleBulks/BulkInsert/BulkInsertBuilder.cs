...
public class BulkInsertBuilder<T>
{
    ...
    public void Execute(IReadOnlyCollection<T> data)
    {
        ...
        var sqlCreateTemptable = TypeMapper.GenerateTempTableDefinition<T>(temptableName, _columnNames, null, _table.ColumnTypeMappings, addIndexNumberColumn: true, discriminator: _table.Discriminator);
        ...
        mergeStatementBuilder.AppendLine($"VALUES ({_table.CreateColumnNames(_columnNames, "b", includeDiscriminator: true)})");
    ...
    public void SingleInsert(T dataToInsert)
    {
        ...
        LogParameters(_table.CreateNpgsqlParameters(insertCommand, dataToInsert, columnsToInsert, includeDiscriminator: true, autoAdd: true));

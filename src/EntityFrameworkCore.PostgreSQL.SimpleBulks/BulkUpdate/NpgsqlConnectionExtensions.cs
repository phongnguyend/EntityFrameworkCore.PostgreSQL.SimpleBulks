...
namespace EntityFrameworkCore.PostgreSQL.SimpleBulks.BulkUpdate
{
    public static class NpgsqlConnectionExtensions
    {
        ...
        public static BulkUpdateResult BulkUpdate<T>(this NpgsqlConnection connection, IEnumerable<T> data, TableInfor table, Expression<Func<T, object>> idSelector, Expression<Func<T, object>> columnNamesSelector, Action<BulkUpdateOptions> configureOptions = null)
        {
            return new BulkUpdateBuilder<T>(connection)
                .WithId(idSelector)
                .WithColumns(columnNamesSelector)
        ...
        public static BulkUpdateResult BulkUpdate<T>(this NpgsqlConnection connection, IEnumerable<T> data, TableInfor table, string idColumn, IEnumerable<string> columnNames, Action<BulkUpdateOptions> configureOptions = null)
        {
            return new BulkUpdateBuilder<T>(connection)
                .WithId(idColumn)
                .WithColumns(columnNames)
        ...
        public static BulkUpdateResult BulkUpdate<T>(this NpgsqlConnection connection, IEnumerable<T> data, TableInfor table, IEnumerable<string> idColumns, IEnumerable<string> columnNames, Action<BulkUpdateOptions> configureOptions = null)
        {
            return new BulkUpdateBuilder<T>(connection)
                .WithId(idColumns)
                .WithColumns(columnNames)

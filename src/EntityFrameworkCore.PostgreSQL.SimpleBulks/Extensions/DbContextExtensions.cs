...
public static class DbContextExtensions
{
    ...
    {
        return new ConnectionContext(dbContext.GetNpgsqlConnection(), dbContext.GetCurrentNpgsqlTransaction());
    }
    ...
    private static void AddJsonOwnedProperty(List<ColumnInfor> columnInfors, INavigation ownedNavigation)
    {
        ...
        var containerColumnType = ownedNavigation.TargetEntityType.GetContainerColumnType() ?? "jsonb";

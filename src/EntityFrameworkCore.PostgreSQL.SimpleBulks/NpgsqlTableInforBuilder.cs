...
public class NpgsqlTableInforBuilder<T>
{
    ...
    public NpgsqlTableInforBuilder<T> ConfigureProperty(string propertyName, string columnName = null, string columnType = null, bool? readOnly = null)
    {
        if (columnName != null)
        {
    ...
    public NpgsqlTableInforBuilder<T> ConfigureProperty(Expression<Func<T, object>> nameSelector, string columnName = null, string columnType = null, bool? readOnly = null)
    {
        var propertyName = nameSelector.Body.GetMemberName();
    ...
    public NpgsqlTableInforBuilder<T> ConfigureComplexProperty(string propertyName)
    {
    ...
    public NpgsqlTableInforBuilder<T> ConfigureComplexProperty(Expression<Func<T, object>> nameSelector)
    {
        var propertyName = nameSelector.Body.GetMemberName();
    ...
    public NpgsqlTableInforBuilder<T> ConfigureDiscriminator(string propertyName, object value, string columnName = null, string columnType = null)
    {
    ...
    public NpgsqlTableInforBuilder<T> ConfigureDiscriminator<TProperty>(Expression<Func<T, TProperty>> nameSelector, TProperty value, string columnName = null, string columnType = null)
    {
        var propertyName = nameSelector.Body.GetMemberName();

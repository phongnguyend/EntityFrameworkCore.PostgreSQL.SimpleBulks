...
public class TempTableAsyncTests : BaseTest
{
    ...
    public TempTableAsyncTests(ITestOutputHelper output, PostgreSqlFixture fixture) : base(output, fixture, "TempTableTest")
    {
    }
    ...
    {
        var connectionContext = new ConnectionContext(_context.GetNpgsqlConnection(), null);
